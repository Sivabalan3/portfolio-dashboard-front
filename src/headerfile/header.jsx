          ...
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between  mx-auto p-3">
            ...
            <div className={icon ? " hidden md:block h-full" : " w-full md:flex md:w-auto md:order-1 items-center justify-between "} id="mobile-menu-2">
              <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border   md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  ...
                  <li className="active" >
                      <NavLink onClick={CloseSideDrawer} to="/about" className=" text-lg font-bold py-2 pl-3 pr-4  rounded  md:hover:bg-transparent md:hover:text-sky-400 md:p-0 text-white md:dark:hover:text-sky-400 dark:hover:bg-gray-700  md:dark:hover:bg-transparent dark:border-gray-700 flex items-center gap-1">
