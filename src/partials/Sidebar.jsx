      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <div className="avatar">
            <div className="w-11 h-11  rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 cursor-pointer">
              <img src={Logo} className="w-12 h-12 text-center" />
            </div>
          </div>
        </div>
                          ...
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <div className="flex gap-1">
                                <GoProject
                                  className={`w-5 h-5 block  truncate transition duration-150 ${
                                    pathname.includes("project-card")
                                      ? "text-slate-200"
                                      : "hover:text-indigo-500"
                                  }`}
                                />
